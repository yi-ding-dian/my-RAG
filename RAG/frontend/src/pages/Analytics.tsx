    ...
    <div>
      ...
      <Card
        ...
        extra={
          <Space>
            {isAdmin ? (
              <Button type="primary" icon={<PlayCircleOutlined />} onClick={openEvalModal}>
                发起评估
              </Button>
            ) : null}
          ...
          <Alert
            ...
            description={
              <span>
                ...
                系统自身统计不受影响，可在知识库管理/文档管理中继续使用； 如需查看评估报告，请先启动
                RAGAS 服务（端口 8090）。
              </span>
            }
          />
                      ...
                      <Row key={field.key} gutter={8} align="top" style={{ marginBottom: 8 }}>
                        ...
                        <Col flex="auto">
                          <Form.Item
                            ...
                            rules={[
                              { required: true, whitespace: true, message: '请输入正确答案' },
                            ]}
                            style={{ marginBottom: 0 }}
                          >
